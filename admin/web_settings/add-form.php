...
checkAdminLoggedIn();
// get data from web settings and news
$getWebSettingsQuery = "select * from web_settings";
$webSettings = queryExecute($getWebSettingsQuery, true);
// get data from news
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Thêm web-settings</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form id="add-settings-form" action="<?= ADMIN_URL . 'web-settings/save-add.php' ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col d-flex justify-content-end">
                                    ...
                                    <a href="<?= ADMIN_URL . 'web-settings' ?>" class="btn btn-danger">Hủy</a>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        $('#add-settings-form').validate({
            rules: {
                ...
                email: {
                    ...
                    email: true,
                    remote: {
                        url: "<?= ADMIN_URL . 'web-settings/verify-email-existed.php' ?>",
                        type: "post",
                        data: {
                            email: function() {
