        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form id="add-banner-form" action="<?= ADMIN_URL . 'banner_slice/save-add.php' ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Mô tả thứ nhất<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="firstContent">
