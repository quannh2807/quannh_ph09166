...
<body>
    <div class="container">
        <div class="col-8 offset-2">
            ...
            <form id="validation" role="form" action="<?php echo BASE_URL . 'save-register.php'; ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control" id="nameUser" name="name" placeholder="Nhập họ và tên">
